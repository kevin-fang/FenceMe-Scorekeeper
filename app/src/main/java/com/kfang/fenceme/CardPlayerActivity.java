...
public class CardPlayerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (playerToCard.equals(redName)) {
            numYellow = MainActivity.redPlayerCards.get(Utility.RED_CARDYELLOW);
            ...
            numRed = MainActivity.greenPlayerCards.get(Utility.GREEN_CARDRED);
    ...
    public void displayRed(View v) {
        ...
        if (playerToCard.equals(redName)) {
            MainActivity.redPlayerCards.put(Utility.RED_CARDRED, numRed + 1);
        } else if (playerToCard.equals(greenName)) {
            MainActivity.greenPlayerCards.put(Utility.GREEN_CARDRED, numRed + 1);
        }
    ...
    public void displayYellow(View v) {
        if (playerToCard.equals(redName)) {
            MainActivity.redPlayerCards.put(Utility.RED_CARDYELLOW, numRed + 1);
        } else if (playerToCard.equals(greenName)) {
            MainActivity.greenPlayerCards.put(Utility.GREEN_CARDYELLOW, numRed + 1);
        }
